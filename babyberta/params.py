...
param2default = {
    ...
    'consecutive_masking': True,  # better dev pp and grammatical accuracy when false
    ...
    'corpora': ('aochildes',),
    'tokenizer': 'aochildes+KCDS',  # larger than 8k slightly reduces performance
    'add_prefix_space': True,  # better if True, whether to treat first token like any other token (False in GPT-2)
    'max_input_length': 64,  # unacceptable performance if lower than ~32
